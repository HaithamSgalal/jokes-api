...
app.get("/random", (req, res) => {
  // indentifing a random index for a joke.
  const jokeIndex = Math.floor(Math.random() * 100);
  // returning jockes which is in a JS object format into a JSON
...
app.get("/jokes/:id", (req, res) => {
  ...
  // using find to search in the joks array
...
app.get("/jokes", (req, res) => {
  //getting the joke type
  const type = req.query.jokeType;
  //filttering joks array
  const filteredJoke = jokes.find((joke) => joke.jokeType === jokeType);
  //returning JSON
...
app.patch("/jokes/:id", (req, res) => {
  ...
  const replacementJoke = {
    id : id,
    jokeText: req.body.jokeText || exisitingJoke.jokeText,
    jokeType: req.body.jokeType || exisitingJoke.jokeType
  }
